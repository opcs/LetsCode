...
class KthSmallst
{
    ...
    // to left of it and greater elements to right. This function is used by randomPartition()
    ...
    // Picks a random pivot element between l and r and partitions arr[l..r] arount the randomly picked element using partition()
